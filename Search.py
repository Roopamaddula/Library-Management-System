...
class Search(Tk):
    def __init__(self):
        ...
        self.listTree = ttk.Treeview(self, height=13,columns=('Book Name', 'Book Author', 'Availability', 'Reserved' , 'Reserved By'))
        ...
        self.listTree.heading("Reserved", text='Reserved')
        self.listTree.column("Reserved", width=200, anchor='center')
        self.listTree.heading("Reserved By", text='Reserved By')
        self.listTree.column("Reserved By", width=200, anchor='center')
        self.listTree.bind('<Button-1>', handle)
        self.listTree.place(x=40, y=200)
        self.vsb.place(x=1180,y=200,height=287)
