        ...
        def check():
            try:
                ...
                if not z:
                    ...
                    #label and input box
                    self.label3 = Label(self, text='STUDENT VIEW: Welcome ',fg='black',bg="gray" ,font=('Courier new', 30, 'bold'))
                    self.label3.place(x=500, y=22)
                    ...
                    self.label5.place(x=130, y=107)
                    self.bookid = Entry(self, textvariable=self.b, width=90)
                    self.bookid.place(x=405, y=110)
                    self.brt = Button(self, text='Find', width=15, font=('arial', 10),command = ent).place(x=1000, y=106)
                    ...
                    self.button = Button(self, text='Search Book', width=15, font=('Courier new', 10), command=sea).place(x=550,y=250)
                    ...
                    self.brt = Button(self, text="Reserve Book", width=15, font=('Courier new', 10), command=res).place(x=700, y=250)
