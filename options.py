...
#creating table
        ...
        list1.add_command(label="1) Add Book", command=a_b)
        list1.add_command(label = "2) Add Admin User",command = add_user)
        list1.add_command(label = "3) Remove Admin User",command = rem_user)
        #list1.add_command(label = "4) Add Student",command = a_s)
        list1.add_command(label = "5) Remove Student",command = r_s)
        ...
        def check():
            try:
                ...
                if not z:
                    ...
                    #label and input box
                    self.label3 = Label(self, text='ADMIN VIEW: Welcome',fg='black',bg="gray" ,font=('Courier new', 30, 'bold'))
                    ...
                    self.brt = Button(self, text="Reserve Book", width=15, font=('Courier new', 10), command=res).place(x=1150, y=250)
